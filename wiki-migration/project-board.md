...
- [ ] **Epic B — Core chat pipeline & short-term memory**
  ...
  - [ ] Story B.2: Short-term memory API (add/list/delete) with canonical quotas. — owner: Backend, estimate: 4 days
...
- [ ] **Epic C — Long-term memory, meditation, and pruning**
  ...
  - [ ] Story C.2: Long-term persistence and retention/migration tests. — owner: Backend, estimate: 4 days
...
Update this file as work progresses. For automation, consider migrating to GitHub Projects once issues are created.