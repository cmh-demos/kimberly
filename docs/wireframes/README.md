...
Low-fidelity wireframes (desktop + mobile) for the initial UI surface: Chat, Memory Manager, and Agents.

Files added:

- chat-desktop.svg — desktop chat screen showing conversation, composer, and the context/memory preview panel.
- chat-mobile.svg — mobile chat layout with composer and tappable context preview.
- memory-desktop.svg — desktop Memory Manager with filters, quota bar, list and detail panel.
