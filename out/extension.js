...
function extractMentionedAgents(message) {
    const agentIds = [
...
async function getAgentResponses(mentionedAgents, originalMessage, chatContext) {
    const responses = [];
...
async function simulateAgentResponse(agentId, prompt) {
    const roleResponses = {
